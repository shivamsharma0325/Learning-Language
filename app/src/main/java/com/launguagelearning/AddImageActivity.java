...
public class AddImageActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ProgressDialog pd;
    Button btn_submit;
    EditText et_name;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(AddImageActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(AddImageActivity.this,new String[]{
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, AddImageActivity.this);
    }
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_GALLERY_CODE && resultCode == Activity.RESULT_OK) {
            ...
            if (EasyPermissions.hasPermissions(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                String filePath = getRealPathFromURIPath(uri, AddImageActivity.this);
    ...
    private void uploadImageToServer(){
        ...
        fileUpload.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                pd.dismiss();
                Toast.makeText(AddImageActivity.this, response.body().message, Toast.LENGTH_LONG).show();
                finish();
            }
            @Override
            public void onFailure(Call<ResponseData> call, Throwable t) {
                pd.dismiss();
                Toast.makeText(AddImageActivity.this, "Error"+t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
