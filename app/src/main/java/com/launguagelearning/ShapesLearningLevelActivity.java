...
public class ShapesLearningLevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLevel1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(), ShapesLearningActivity.class);
    ...
    private void getLevel1(String uname,String ctype) {
        pd = new ProgressDialog(ShapesLearningLevelActivity.this);
