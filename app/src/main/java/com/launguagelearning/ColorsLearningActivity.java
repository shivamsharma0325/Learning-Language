...
public class ColorsLearningActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getLessions() {
        pd = new ProgressDialog(ColorsLearningActivity.this);
        pd.setTitle("Please wait,Data is being loaded...");
        pd.show();
        EndPointUrl apiService = RetrofitInstance.getRetrofitInstance().create(EndPointUrl.class);
        Call<List<Lessons>> call = apiService.getColorsLessions();
                ...
                if (response.code()==200) {
                    if (response.body() != null) {
                        if(response.body().size()>0) {
                            ...
                            mViewPagerAdapter = new AnimalViewPagerAdapter(ColorsLearningActivity.this, response.body());
