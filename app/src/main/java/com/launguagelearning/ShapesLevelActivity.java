...
public class ShapesLevelActivity extends BaseActivity {
    Button btnLevel1,btnLevel2,btnLevel3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shapes_level);
        getSupportActionBar().setTitle("Shapes Levels");
        ...
        btnLevel2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getLevel1(sharedpreferences.getString("uname","-"),"Shapes");
            }
        });
        btnLevel3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);*/
                SharedPreferences sharedpreferences = getSharedPreferences("MyPref", Context.MODE_PRIVATE);
                getLevel2(sharedpreferences.getString("uname","-"),"Shapes");
            }
        });
    }
    @Override
    ...
    private void getLevel1(String uname,String ctype) {
        pd = new ProgressDialog(ShapesLevelActivity.this);
